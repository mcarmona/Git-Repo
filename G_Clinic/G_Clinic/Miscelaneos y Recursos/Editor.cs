...
namespace G_Clinic
{
    public partial class Editor : UserControl//, SearchableBrowser
    {
        ...
        private bool initialFont = false;
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            //else
            //{                
            //    fontComboBox.SelectedIndex = fontComboBox.Items.IndexOf("Arial");
            //    fontComboBox_TextChanged(sender, e);
        ...
        {
            initialFont = false;
            webBrowser1.Document.ExecCommand("FontName", false, "Arial");
